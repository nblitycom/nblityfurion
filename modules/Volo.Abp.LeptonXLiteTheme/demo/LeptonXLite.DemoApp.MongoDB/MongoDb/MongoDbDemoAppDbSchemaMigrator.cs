...
using LeptonXLite.DemoApp.Data;
using Volo.Abp.Data;
...
{
    public class MongoDbDemoAppDbSchemaMigrator : IDemoAppDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbDemoAppDbSchemaMigrator(IServiceProvider serviceProvider)
        {
