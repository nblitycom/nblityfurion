...
namespace LeptonXLite.DemoApp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("DemoApp") == null)
        {
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var blazorServerTieredRootUrl = configurationSection["DemoApp_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');
